...
Original file is located at
    https://colab.research.google.com/drive/1NH2gbTO8XxNENHAoirY7lvaaFLp10YV6
"""
...
def get_filters():
    ...
    while True:
        city = input(
            'Which city you want to analyze?\n Chicago, New York City or Washington\n').lower()
...
def station_stats(df):
    ...
    print(
        f'The most common Start Station is {pop_start} with count: {count_start}')
    ...
    print(
        f'The most frequent combination is {pop_combination} with count: {count_combination}')
...
def user_stats(df):
    ...
    if 'Birth Year' in df.columns:
        earlist, recent, common = df['Birth Year'].min(
        ), df['Birth Year'].max(), df['Birth Year'].value_counts().keys()[0]
...
def main():
    ...
    while True:
        ...
        view = input(
            'You would like to view the 5 lines of the dataset? Enter yes or no.\n').lower()
    ...
    if restart.lower() != 'yes':
        # break
        #you must use break inside a loop
        pass
